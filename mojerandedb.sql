...
VALUES (5, 2, 4, '2024-03-27 11:14:47');
...
TRUNCATE `dates`;
INSERT INTO `dates` (`ID`, `senderEmail`, `recipientEmail`, `dateCreated`, `dateInvitation`, `message`, `place`,
                     `confirmed`)
VALUES (45, 'matyaszavora@outlook.com', 'ozzak@seznam.cz', '2024-03-25 13:20:07', '2024-03-25 12:00:00',
        'Stav se večer, provedu tě rájem', 'U mě doma <3', 1);
