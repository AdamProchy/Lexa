                    ...
                    <form method="post">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="czk" name="czk" min="0" step="10"
                                       required <?php if (isset($pendingRequest) and $pendingRequest) echo "readonly value='$pendingAmountCZK'" ?>>
                                <span class="input-group-text">=</span>
                                <input type="number" class="form-control" id="coins-czk" name="coins-czk" min="0"
                                       step="1"
                                       required <?php if (isset($pendingRequest) and $pendingRequest) echo "readonly value='$pendingAmount'" ?>>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <img id="qr-code"
                                 src="https://api.paylibo.com/paylibo/generator/czech/image?accountNumber=2978644003&bankCode=0800&amount=0&currency=CZK&vs=<?= $variableSymbol ?>"
                                 class="img-fluid">
                        </div>
                        ...
                        <button type="submit" name="buy-coins"
                                class="btn btn-success d-block mx-auto" <?php if (isset($pendingRequest) and $pendingRequest) echo "disabled" ?>>
                            Poslat žádost o přidání coinů
                        </button>
                    </form>
                    <h5 class="text-center mt-5">Jak to funguje?</h5>
                    <p class="text-center text-muted">Nastavte si počet coinů, které si chcete koupit, pošlete peníze na
                        účet pomocí QR kódu nebo manuálně a zažádejte si o přidání.</p>
                    <p class="text-center text-muted">Po obdržení peněz a odsouhlasení administrátora Vám budou coiny
                        přidány na váš účet.</p>
                </div>
